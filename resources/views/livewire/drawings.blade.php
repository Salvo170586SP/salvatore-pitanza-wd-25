        ...
        <div class="text-center w-full pb-10">
            <h2 class="font-bold text-3xl md:text-4xl flex items-end justify-center gap-2">
                ...
                <div class="text-[30px] uppercase">
                   My <span class='text-gray-500'>Drawings</span>
                </div>
            </h2>
            <p class="font-medium text-sm mt-2">I create portraits on request. Drawings made with graphite and charcoal <br> *Hover over the image to see details.</p>
        </div>

<div class="relative min-h-screen overflow-hidden bg-gray-200/50 " id="home">
    ...
    <div id="particles-js" class="absolute inset-0 top-0 bottom-0 left-0 right-0" style="pointer-events: all; z-index: -1;"></div>
     <header x-data="{ isOpen: false, activeTab: 'home', scrolled: false }" 
        ...
        :class="{'!py-1 px-10 -mx-10 -my-2': scrolled}"
        class="fixed top-0 left-0 right-0 px-5 py-3 z-50 transition-all duration-300">
         <!-- Navigation bar -->
         <div
         :class="{'!mx-0 !rounded-none': scrolled}"
         class="flex flex-col md:flex-row items-center justify-between bg-white shadow-lg border rounded-xl px-4 md:px-10 py-3 mx-4 md:mx-10 lg:mx-40 transition-all duration-300">
    ...
    <section id="jumbtron" class="z-20 flex justify-center mt-30 md:mt-32 lg:mt-82 px-4 md:px-0">
        <div
            ...
            <div class="text-center md:text-left">
                ...
                <a href="#about"
                    class="bg-[#002057] w-[200px] flex items-center justify-center mx-auto md:mx-0 text-white rounded-xl font-semibold px-6 md:px-8 py-3 cursor-pointer transition shadow-[#002057] shadow hover:shadow-md text-sm md:text-base">About
                    Me
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-7 ms-2">
                ...
                <div class="flex items-center justify-center md:justify-start gap-4 mt-5">
                    ...
                    <button title="Instagram"
                        class="mt-4 cursor-pointer bg-slate-100 p-2 rounded-full shadow-md hover:shadow-lg transition-all border">
                        <img class="w-6 md:w-7 h-6 md:h-7" src="{{asset('imgs/icon/instagram.svg')}}" alt="Instagram">
                    </button>
                </div>
            </div>

        ...
        <div
            ...
            <div class="text-center w-full md:w-auto md:text-left max-w-lg flex flex-col justify-center">
                <div class="text-[#002057] text-2xl md:text-4xl lg:text-[4rem] font-bold mb-3 md:mb-5">
                  Hi Devs, <br />I'm Salvatore <span class='text-yellow-500'>Pitanza</span>
                </div>
                <a href="#about"
            ...
            <figure
                ...
                <img src="{{asset('imgs/icon/logo2.png')}}" alt="logo-jumb" class="tilt-element w-[250px] h-[250px] md:w-[300px] md:h-[300px] lg:w-[400px] lg:h-[400px] 

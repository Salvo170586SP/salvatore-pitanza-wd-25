    ...
    <div class="w-full relative px-3 text-black dark:text-white">
        <div class="max-w-full mx-5 p-5">
            <div class="h-[66px] flex items-center justify-between mb-10">
                <h3 class="text-lg font-bold uppercase">Documents / Edit</h3>
            ...
            <div x-data="{ fileName: '', imageUrl: '', isPdf: {{ Str::endsWith($img_url, '.pdf') ? 'true' : 'false' }} }"
                ...
                <div class="text-sm text-gray-600">
                    <div class="space-y-2">
                        <template x-if="isPdf">
                            <div class="w-[250px] h-[250px] overflow-hidden shadow-md rounded-lg bg-gray-100 dark:bg-[#505050] flex flex-col items-center justify-center">
                                ...
                                <p class="mt-4 px-4 text-xs text-gray-600 dark:text-white text-center break-words max-w-full" x-text="fileName || '{{ basename($img_url) }}'"></p>
                            </div>
                        </template>
                        <template x-if="!isPdf">

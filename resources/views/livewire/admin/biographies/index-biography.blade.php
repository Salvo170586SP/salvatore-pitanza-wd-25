        ...
        <div class="max-w-full mx-5 p-5">
            ...
            <div class="flex gap-4 mt-10">
                @forelse($biographies as $biography)
                    <div class="space-y-2">
                        <figure class="w-[350px] h-[369px] shadow bg-white rounded-xl overflow-hidden">
                    ...
                    <div class="w-full">
                        <div
                            class="bg-slate-50 mb-5 dark:border-[#505050] dark:bg-[#505050] shadow p-5 rounded-xl w-full">
                            <span class="font-bold">Eng</span> <br><br>
                            {!! $biography->description !!}
                        </div>
                        <div class="bg-slate-50  dark:border-[#505050] dark:bg-[#505050] shadow p-5 rounded-xl w-full">
                            <span class="font-bold">Ita</span> <br><br>
                            {!! $biography->description_ita !!}
                        </div>
                    </div>
                @empty
                    <div
                        class="w-[600px] h-[400px] flex items-center justify-center text-lg font-bold text-orange-400 rounded-lg overflow-hidden border bg-yellow-50">
                        NO IMG
                    </div>
                    <div

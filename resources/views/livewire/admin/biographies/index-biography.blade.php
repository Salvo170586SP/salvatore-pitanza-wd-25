        ...
        <div class="max-w-full mx-5 p-5 bg-white rounded-lg">
            <div class="bg-white flex items-center justify-between mb-5">
                <div class="text-gray-900">
                    <h3 class="text-[#080808] flex items-center text-lg font-bold uppercase">Biographies
                    </h3>
                </div>
            </div>
            ...
            <div class="h-[66px] flex items-center justify-end">
                ...
                <button wire:navigate href="/admin/biographies/{{auth()->user()->id}}/edit"
                    class="cursor-pointer flex justify-evenly items-center rounded-md w-[180px] h-[36px] bg-blue-500 hover:bg-blue-600 text-[15px] font-semibold text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div class="flex gap-4 mt-10">
                ...
                <div class="text-gray-700 bg-slate-50 shadow p-5 rounded-xl w-full">{{ $biography->description }}</div>
                @empty
                <figure class="w-[600px] h-[400px] shadow bg-white rounded-xl overflow-hidden">
                ...
                <div class="text-gray-400 bg-slate-50 shadow p-5 rounded-xl w-full flex justify-center items-center">Write a
                    biography</div>
                @endforelse
            </div>
        </div>

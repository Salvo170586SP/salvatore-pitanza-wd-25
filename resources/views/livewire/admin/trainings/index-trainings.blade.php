    ...
    <div class="w-full h-full px-3 text-black dark:text-white">
        <div class="max-w-full mx-5 p-5 rounded-lg">
            ...
            <div class="h-[66px] flex items-center justify-end">
                <button wire:navigate href="/dashboard/trainings/create"
            ...
            <div class="w-full overflow-hidden rounded-xl">
                <table class="w-full border border-gray-100 dark:border-0">
                    ...
                    <tbody class="bg-[#FAFAFA] dark:bg-[#222222]">
                        ...
                        <tr class="@if(!$loop->last) border-b @endif dark:border-[#3d3d3d] h-[55px]" wire:key="training-{{$training->id}}">
                            <td>
                                <div class="p-4">
                            ...
                            <td>
                                <div class="flex items-center justify-end">
                                    <button wire:navigate href="/dashboard/trainings/{{$training->id}}"
                                    ...
                                    <button wire:navigate href="/dashboard/trainings/{{$training->id}}/edit"

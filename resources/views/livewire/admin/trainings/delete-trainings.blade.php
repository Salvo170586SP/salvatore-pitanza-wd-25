<div class="p-5 text-black dark:text-white dark:bg-[#3b3b3b]">
   ...
   <div class="text-end mt-5">
      ...
      <button class="bg-red-500 hover:bg-red-600 dark:bg-red-700 dark:hover:bg-red-800 text-white cursor-pointer rounded-lg px-4 py-2" wire:click="deleteTraining">Delete</button>
   </div>
</div>
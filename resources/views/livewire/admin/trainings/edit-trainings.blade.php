    ...
    <div class="w-full relative px-3 text-black dark:text-white">
        <div class="max-w-full mx-5 p-5">
            <div class="h-[66px] flex items-center justify-between mb-10">
                <h3 class="text-lg font-bold uppercase">Training / Edit</h3>
               ...
               <div class="w-full flex flex-col mb-5">
                    <div class="w-full  flex flex-col justify-between">
                        ...
                        <textarea  wire:model="icon_url" id="icon_url" rows="5"
                            class="bg-gray-100 hover:bg-gray-200 dark:border-[#505050] dark:bg-[#505050] dark:hover:bg-[#5e5e5e] px-1 rounded  w-full text-md">
                        </textarea>
                    </div>
                    @error('icon_url')
                    <small class="text-red-500">{{ $message }}</small>
